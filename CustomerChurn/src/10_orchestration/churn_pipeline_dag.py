...
feast_update_task = PythonOperator(
    task_id="update_feast_store",
    python_callable=run_script,
    op_kwargs={"script_path": "src/07_feature_store/feature_definitions.py", "task_name": "Feast Feature Store Update"},
    dag=dag
)
...
[ingestion_task_loc, ingestion_task_api] >> validation_task >> preparation_task >> transformation_task >> feast_update_task >> model_training_task
